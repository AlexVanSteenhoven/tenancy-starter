...
export default function TwoFactorChallenge() {
    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                title: t('auth.two-factor.challenge.recovery-code.title'),
                description: t(
    ...
    return (
        ...
        >
            <Head title={t('auth.two-factor.challenge.meta.title')} />
                    ...
                    {({ errors, processing, clearErrors }) => (
                        <>
                            {showRecoveryInput ? (
                                <>
                                    <Input
                                        ...
                                        type="text"
                                        placeholder={t(
                                            'auth.two-factor.challenge.recovery-code.placeholder',
                                        )}
                            ...
                            <Button
                                ...
                                disabled={processing}
                            >
                                {t('auth.two-factor.challenge.form.submit')}
                            </Button>

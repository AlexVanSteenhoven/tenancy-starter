        ...
        <AdminLayout>
            ...
            <div className="space-y-4">
                <h1 className="text-2xl font-semibold">
                    {t('admin.subscriptions.show.meta.title')}
                </h1>
                <Card>
                    <CardHeader>
                    ...
                    <CardContent className="space-y-2 text-sm">
                        <p>
                            {t('admin.subscriptions.show.fields.domain')}:{' '}
                            {subscription.workspace_domain ??
                                t('admin.common.not_available')}
                        </p>
                        <p>
                            {t('admin.subscriptions.show.fields.status')}:{' '}
                            {subscription.stripe_status}
                        </p>
                        <p>
                            {t('admin.subscriptions.show.fields.stripe_id')}:{' '}
                            {subscription.stripe_id}
                        </p>
                        <p>
                            {t('admin.subscriptions.show.fields.stripe_price')}:{' '}
                            {subscription.stripe_price ??
                                t('admin.common.not_available')}
                        </p>
                        <p>
                            {t(
                                'admin.subscriptions.show.fields.cancel_at_period_end',
                            )}
                            :{' '}

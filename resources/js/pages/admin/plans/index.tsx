    ...
    const columns: ColumnDef<PlanRow>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => (
                ...
                >
                    {row.original.is_active
                        ? t('admin.plans.status.active')
                        : t('admin.plans.status.inactive')}
                </Badge>
            ),
        },
        {
            ...
            cell: ({ row }) =>
                `${row.original.stripe_product_id ?? '-'} / ${row.original.stripe_price_id ?? '-'}`,
        },
    ];
        ...
        <AdminLayout>
            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>
                            {t('admin.plans.stripe_instructions.title')}
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p className="text-sm text-muted-foreground">
                            {t('admin.plans.stripe_instructions.description')}
                        </p>
                        <ul className="mt-4 list-disc space-y-2 pl-5 text-sm text-muted-foreground">
                            <li>
                                {t('admin.plans.stripe_instructions.step1')}
                            </li>
                            <li>
                                {t('admin.plans.stripe_instructions.step2')}
                            </li>
                            <li>
                                {t('admin.plans.stripe_instructions.step3')}
                            </li>
                            <li>
                                {t('admin.plans.stripe_instructions.step4')}
                            </li>
                            <li>
                                {t('admin.plans.stripe_instructions.step5')}
                            </li>
                        </ul>
                    </CardContent>
                </Card>

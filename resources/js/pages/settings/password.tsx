...
export default function Password() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        {
            title: t('settings.password.meta.title'),
            href: edit().url,
        },
    ];
                            ...
                            <>
                                <div className="grid gap-2">
                                    <Label htmlFor="current_password">
                                        {t(
                                            'settings.password.form.current_password.label',
                                        )}
                                    </Label>
                                    ...
                                    <Input
                                        ...
                                        placeholder={t(
                                            'settings.password.form.current_password.placeholder',
                                        )}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder={t(
                                            'settings.password.form.password.placeholder',
                                        )}
                                    />
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="password_confirmation">
                                        {t(
                                            'settings.password.form.password_confirmation.label',
                                        )}
                                    </Label>
                                    ...
                                    <Input
                                        ...
                                        autoComplete="new-password"
                                        placeholder={t(
                                            'settings.password.form.password_confirmation.placeholder',
                                        )}
                                    />

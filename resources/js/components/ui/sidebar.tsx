        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetHeader className="sr-only">
                    <SheetTitle>{t("app.ui.sidebar.title")}</SheetTitle>
                    <SheetDescription>{t("app.ui.sidebar.description")}</SheetDescription>
                </SheetHeader>
                <SheetContent
...
function SidebarTrigger({
    ...
    return (
        ...
        >
            ...
            <span className="sr-only">{t("app.ui.sidebar.toggle")}</span>
        </Button>
    )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
    ...
    return (
        <button
            ...
            aria-label={t("app.ui.sidebar.toggle")}
            tabIndex={-1}
            onClick={toggleSidebar}
            title={t("app.ui.sidebar.toggle")}
            className={cn(
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
    return (
        <main
            ...
            className={cn(
                "bg-background/50 relative flex min-w-0 min-h-svh flex-1 flex-col px-4 sm:px-6 lg:px-8",

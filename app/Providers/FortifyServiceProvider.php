...
use App\Http\Responses\TwoFactorResponse;
...
use Laravel\Fortify\Contracts\TwoFactorLoginResponse as FortifyTwoFactorResponse;
...
final class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureResponses(): void
    {
        ...
        $this->app->singleton(FortifyTwoFactorResponse::class, TwoFactorResponse::class);
    }
}
